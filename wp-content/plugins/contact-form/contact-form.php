...
function contact_form_plugin()
{
    ...
    $content .= '<form method="post" action="https://khamphataynguyen.com/thank-you/">';
    ...
    $content .= '<textarea name="your_comments" class="form-control" placeholder="Enter your Question or Comments"></textarea>';
